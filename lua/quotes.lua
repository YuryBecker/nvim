return {
  ...
  [[
    Interpretation is imposed by other.
    Paintings are to be admired or contemplated.
    Admired without asking what it means.
    If I had something to say I'd write it down or say it.
    I don't need painting for that.,
  ]],
  ...
  [[
    One reason it was profitable to carve up 1980s companies
    and sell them for parts was that they hadn't formally acknowledged
    their implicit debt to employees who had done good work and expected
    to be rewarded with high-paying executive jobs when their time came.
  ]],
  ...
  [[
    ...
    but lack of preparation guarantees failure.
  ]],
  ...
  [[
    A kid proudly told his father that he saved a quarter by running alongside
    a bus rather than taking it. The father slapped the kid on
    the head and told him that he could saved $20 if he ran alongside a taxi.
  ]],

  [[
    Between youth and wisdom there is a chasm that words can not help cross.
  ]],
  ...
  [[
    ...
    inevitable have his choice made for him by circumstance.
  ]],
  ...
  [[
    It's all the crazy coming together.
    Unchecked by societal norms and public courtesies.
    A red carpet of familial madness gathered around a table that's one chair too small.
  ]],

  [[
    I finally learned to dance and the party is almost over.
  ]],

  [[
    There was an engineer who had an exceptional gift for fixing
    all mechanical things. After serving his company loyally for over 30 years,
    he happily retired. Several years later his company contacted him regarding
    ...
    of the machine and proudly stated, 'This is where your problem is!'
